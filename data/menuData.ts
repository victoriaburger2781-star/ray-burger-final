// --- CONFIGURACIÓN CENTRAL DE RAY BURGER GRILL ---
...
export const WEEKLY_SPECIAL = {
  active: true, // Pon false para ocultarlo
  name: "La Monster Ray",
  price: "$200",
...
// 4. TU MENÚ (Edita aquí los precios y nombres)
export const MENU_ITEMS = [
  ...
  { 
    ...
    name: "Ray Classic", 
    price: "$120", // ¡Cambia este precio aquí!
